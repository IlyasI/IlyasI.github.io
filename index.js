$(document).ready(function(w) {
    function init() {
     	...
     	speck_count = Math.min(Math.pow((canvas_width + canvas_height),1.15), 5000);
    ...
    function random_movement(cell_data, pen_size) {
        ...
        cell_data.xv += (Math.random()*(cell_data.x - cell_data.y)/200) - ((cell_data.y - cell_data.x)/100);
        cell_data.yv += (Math.random()*(cell_data.y - cell_data.x)/200) - ((cell_data.x - cell_data.y)/  100);
    }
